var baseDBFunction = require('../baseDBFunction'); //mongoDB 관련 커스텀함수 모듈
 ...
 module.exports = {
                      ...
                      return new Promise((resolve,reject)=>{
                        ...
                        for(let j=0; j<attend.length; j++){
                          ...
                          for(let k=0; k<attend_info.length; k++){
                            let attend_date = attend_info[k].attend_date;
                            ...
                            for(let l=0; l<attendence.length; l++){
                              ...
                              if(id === attend_studentID ){
                                ...
                                object_attend.attend_date.push(attend_date);
                              }
                            }

                            for(let n=0; n<queryLectureByID.length; n++){
                              if(lecture_id == queryLectureByID[n].lecture_id ){
                                object_attend.lecture_name.push(queryLectureByID[n].lecture_name); //수업명
                              }
                            }
                          }
                        }
    ...
    updateStudentAttend : (updateObject)=>{
        return baseDBFunction.updateAttendUsingArrayFilters(updateObject);
    },
